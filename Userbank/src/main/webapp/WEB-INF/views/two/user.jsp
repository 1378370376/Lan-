...
<body  class="cbp-spmenu-push">
			...
			<div class="bs-example widget-shadow" > 					
				<h4>存款</h4>
					<table class="table table-bordered"> 					
						 ...
						 <div class="col-md-2">
							<font color="red" id="moneyfont"style="visibility:hidden">存款金额格式不正确</font>
						</div> 
						<span>  <font color="red">只能存整数类型</font></span>
						  </td>	
						  </tr> 					  
						 </table>
	...
	function tj(){
		...
		var money=$("#money").val();
		  $.ajax({
				url : "${path}/updateSaveMoneyTrade/${sessionScope.user.id}",
				type : "POST",
				data :{ 
					"_method":"PUT",
					"time":time,
