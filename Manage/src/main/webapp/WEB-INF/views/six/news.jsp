	...
	<div class="main-content">
		...
		<div id="page-wrapper">
			...
			<div class="bs-example widget-shadow" > 					
				<h4> 新闻信息</h4>
							<div class="form-body">
							<form action="${path}/ssNews" method="post">
					...
					<div style="font-size:20px;background-color: skyblue;width:110px;padding:10px" >
							<a href="${path}/showAddNews">添加新闻</a>
						</div>
					<table class="table table-bordered"> 					
						...
						<nav>
							<ul class="pagination pagination-lg">
								...
								<li><a href="${path}/Newslist" >首页</a></li>
								<c:if test="${page.hasPreviousPage}">
								<li><a href="${path}/Newslist?pn=${page.pageNum - 1}" aria-label="Previous"><span aria-hidden="true">«</span></a></li>
								</c:if>
							...
							<c:if test="${page_Num != page.pageNum }">
								<li><a href="${path}/Newslist?pn=${page_Num}">${page_Num}</a></li>
							</c:if>
						</c:forEach>
								<c:if test="${page.hasNextPage}">
								<li><a href="${path}/Newslist?pn=${page.pageNum+1}" aria-label="Next"><span aria-hidden="true">»</span></a></li>
								</c:if>
								<li> <a href="${path}/Newslist?pn=${page.pages}">末页</a></li>
							</ul>
						</nav>
						</div>
						</div>
